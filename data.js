(function () {
  ...
  tf(1, "An acid gives OH-.", false, "That is the base definition. The acid gives H+.");
  ...
  fill(1, "The solution specific heat Cp is approximately ____ J/g.C.", ["4.18", "4.18 J/g.C"], "4.18 J/g.C", "The approximate Cp value is 4.18 J/g.C.");
  multi(1, "Select all chemical reaction types.", ["formation", "combustion", "neutralization", "chromatography", "single replacement", "evaporation only"], ["formation", "combustion", "neutralization", "single replacement"], "formation, decomposition/separation, single replacement, double replacement, combustion, and neutralization as reaction types.");
  ...
  multi(1, "Which statements are correct for Experiment 1?", ["q = Cp * m * Delta T", "Delta H = -q", "Cp is about 4.18 J/g.C", "Delta T = T1 - T2", "Base gives H+"], ["q = Cp * m * Delta T", "Delta H = -q", "Cp is about 4.18 J/g.C"], "The correct statements match the formulas and constants; Delta T is T2 - T1, and acid gives H+.");
  ...
  mcq(2, "Which set contains only solution types?", ["True, colloidal, suspended", "Acidic, basic, neutral", "Organic, inorganic, metallic", "Hot, cold, concentrated"], "True, colloidal, suspended", "true solutions, colloidal solutions, and suspended solutions.");
  ...
  mcq(2, "Which formula calculates molality?", ["m = n / mass of solvent (kg)", "M = n / V_L", "q = Cp * m * Delta T", "Kf = W * 128 * Delta T / 1000"], "m = n / mass of solvent (kg)", "Molality is m = n divided by solvent mass in kg.");
  ...
  tf(2, "A suspended solution is not part of the Experiment 2 list.", false, "Suspended solutions are one solution type.");
  ...
  mcq(2, "A student has 0.40 mol solute and 2.0 kg solvent. Which concentration type can be calculated directly?", ["Molality", "Molarity", "Freezing point constant", "Heat of neutralization"], "Molality", "Molality uses moles of solute and kilograms of solvent.");
  mcq(2, "A student knows only the final solution volume in liters and moles of solute. Which concentration type is most appropriate?", ["Molarity", "Molality", "Percent by mass only", "Electrical conductivity"], "Molarity", "Molarity uses moles of solute per liter of solution.");
  tf(2, "Using the mass of the solvent instead of the volume of the final solution is the key idea in molality.", true, "Molality is calculated from moles of solute per kilogram of solvent.");
  tf(2, "A suspended solution is the same as a true solution.", false, "True, colloidal, and suspended solutions are different solution types.");
  mcq(2, "Which situation best represents a concentration question?", ["Comparing how much solute is present in a fixed amount of solution", "Naming the products of neutralization", "Finding whether a tube feels hot", "Drawing benzene rings only"], "Comparing how much solute is present in a fixed amount of solution", "Concentration expresses solute amount relative to a defined amount of solution or solvent.");
  multi(2, "Which details are needed to calculate molality?", ["moles of solute", "mass of solvent in kg", "color of the solution", "temperature of the room", "liter volume of final solution only"], ["moles of solute", "mass of solvent in kg"], "Molality needs moles of solute and kilograms of solvent.");
  matching(2, "Match each solution type to the best description.", [{ left: "True solution", right: "Uniform solution type" }, { left: "Colloidal solution", right: "Intermediate dispersed mixture" }, { left: "Suspended solution", right: "Mixture with particles that can settle" }], "These three categories separate common solution behavior.");
  mcq(2, "A calculation uses kilograms of water as the denominator. What common mistake should be avoided?", ["Replacing kg solvent with liters of solution", "Changing moles into heat", "Using T2 - T1", "Dividing by 1000 twice"], "Replacing kg solvent with liters of solution", "Molality uses kg of solvent; liters of solution belong to molarity.");
  tf(2, "Percent concentration and trace concentration units are different ways to express amount of solute.", true, "Both are concentration expressions, but they are used at different scales.");
  mcq(2, "Which answer best separates solute from solvent?", ["Solute is dissolved; solvent does the dissolving", "Solvent is always the solid", "Solute is always water", "Solute and solvent are always equal amounts"], "Solute is dissolved; solvent does the dissolving", "Concentration depends on distinguishing the dissolved substance from the dissolving medium.");
  multi(2, "Which statements are valid concentration ideas?", ["Concentration compares solute amount with a defined amount of solution or solvent", "Molality uses kg of solvent", "Different solution types include true, colloidal, and suspended", "Concentration is only a temperature reading", "Molality uses liters of final solution"], ["Concentration compares solute amount with a defined amount of solution or solvent", "Molality uses kg of solvent", "Different solution types include true, colloidal, and suspended"], "These statements describe concentration and solution-type concepts correctly.");
  mcq(2, "Why is molality useful when the solvent amount is given by mass?", ["Its denominator is solvent mass in kg", "It requires only temperature", "It ignores moles of solute", "It uses the final solution volume in liters"], "Its denominator is solvent mass in kg", "Molality is based on moles of solute per kilogram of solvent.");
  mcq(2, "Which mixture is least likely to be a true solution?", ["A mixture with visible particles that settle", "Salt fully dissolved in water", "A uniform sugar-water solution", "A clear homogeneous solution"], "A mixture with visible particles that settle", "Visible particles that settle fit a suspended solution better than a true solution.");
  tf(2, "Molality changes if the solvent mass changes while moles of solute stay fixed.", true, "Molality depends on moles of solute divided by kilograms of solvent.");
  ...
  mcq(3, "Which formula calculates molarity?", ["M = n / V_L", "m = n / mass of solvent (kg)", "q = Cp * m * Delta T", "Delta H = -q"], "M = n / V_L", "Experiment 3 gives M = n / V_L.");
  ...
  mcq(3, "A solution contains 0.20 mol solute in 0.50 L solution. What molarity setup is correct?", ["0.20 / 0.50", "0.50 / 0.20", "0.20 * 0.50", "0.50 - 0.20"], "0.20 / 0.50", "Molarity is moles divided by liters of solution.");
  tf(3, "A volume written in mL should be converted to L before calculating molarity.", true, "The molarity equation uses solution volume in liters.");
  mcq(3, "A student has mass and molecular weight but not moles. What should be calculated first?", ["n = Mass / M.wt", "Delta H = -q", "Kf = W * 128 * Delta T / 1000", "m = V * d"], "n = Mass / M.wt", "Moles are calculated from mass divided by molecular weight.");
  mcq(3, "Which mistake gives the wrong molarity?", ["Using solvent mass in kg instead of solution volume in liters", "Converting mL to L", "Dividing moles by liters", "Calculating moles from mass first"], "Using solvent mass in kg instead of solution volume in liters", "Solvent mass in kg belongs to molality, not molarity.");
  multi(3, "Which values can be used together to calculate molarity?", ["moles of solute", "liters of solution", "mass plus molecular weight to find moles", "kg of solvent as the final denominator", "Cp of solution"], ["moles of solute", "liters of solution", "mass plus molecular weight to find moles"], "Molarity uses moles and liters; mass and molecular weight can first be used to find moles.");
  mcq(3, "If two solutions have the same moles of solute, which one has higher molarity?", ["The one with smaller solution volume", "The one with larger solution volume", "They must be equal", "The one with higher Cp"], "The one with smaller solution volume", "For M = n / V_L, smaller volume gives a larger molarity when moles are the same.");
  ...
  mcq(4, "Which unit is used for solubility?", ["g/mL", "J/g.C", "mol/L", "ppm"], "g/mL", "The solubility unit is gram per milliliter.");
  ...
  tf(4, "The solubility unit is J/g.C.", false, "J/g.C is Cp in Experiment 1; solubility is g/mL.");
  tf(4, "Temperature affects solubility.", true, "Temperature is a solubility factor.");
  tf(4, "Solvent amount affects solubility.", true, "The amount of solvent is a solubility factor.");
  ...
  tf(4, "Organic salts need less heat than inorganic complex salts.", true, "The order starts with organic salts, then inorganic complex salts.");
  fill(4, "The unit for solubility is ____.", ["g/mL", "g per mL", "gram per milliliter"], "g/mL", "The solubility unit is g/mL.");
  ...
  fill(4, "The lowest heat-need salt group is ____ salts.", ["organic"], "organic", "The order from lowest to highest starts with organic salts.");
  ...
  matching(4, "Match each solubility item to its meaning.", [{ left: "Solubility", right: "Amount of solute in defined solvent volume" }, { left: "Dissolution temperature", right: "Temperature for complete dissolution" }, { left: "g/mL", right: "Solubility unit" }, { left: "Direct relationship", right: "More solute needs more heat" }], "These definitions and notes are taken from Experiment 4.");
  ...
  multi(4, "Which statements are correct about the solubility experiment?", ["More solute mass requires higher temperature", "The unit is g/mL", "Stirring type is a factor", "Inorganic simple salts need the least heat", "The relation is inverse"], ["More solute mass requires higher temperature", "The unit is g/mL", "Stirring type is a factor"], "the relation is direct and the lowest heat group is organic salts.");
  mcq(4, "Which option is not a factor affecting solubility?", ["Acid gives H+", "Temperature", "Solvent amount", "Solute type"], "Acid gives H+", "Acid ion behavior belongs to acid-base definitions, not solubility factors.");
  tf(4, "Inorganic complex salts are between organic salts and inorganic simple salts in heat need.", true, "The salt order places inorganic complex salts in the middle.");
  ...
  mcq(5, "What causes electrical conductivity in an electrolyte solution?", ["Freely moving ions", "Fixed glass particles", "Only neutral molecules", "Thermometer color"], "Freely moving ions", "Conductivity occurs because ions are free to move.");
  ...
  mcq(5, "In 5% NaCl, 5 g NaCl corresponds to what total solution volume?", ["100 mL", "95 mL", "5 mL", "1 L"], "100 mL", "5 g NaCl corresponds to each 100 mL total solution.");
  ...
  tf(6, "Kf is calculated for benzene.", true, "Benzene's molal freezing-point constant is calculated.");
