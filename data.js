  ...
  const missingInfo = [
    ...
    },
    {
      ...
      points: [
        ...
        "The handwritten notes state that temperature and solubility have a direct relationship: as temperature increases, solubility increases.",
        "The handwritten notes repeat the solubility factors as temperature, amount of solute, amount of solvent, nature/type of solute, and type of stirring.",
      ],
      note: "The PDF covers the main solubility definition and factors, but does not include these classroom/exam hints.",
    },
    {
      exp: 4,
      title: "Salt examples from handwritten notes",
      points: [
    ...
    },
    {
      ...
      points: [
        ...
        "The handwritten notes add that as temperature increases, conductivity increases for a short time, then evaporation occurs and conductivity decreases.",
        "The handwritten notes list concentration forms: weight/weight, volume/volume, and weight/volume.",
